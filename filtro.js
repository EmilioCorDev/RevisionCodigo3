...
function filtrado(productos = [], texto) {
  return productos.filter(item => item.tipo.includes(texto) || item.color.includes(texto)); //esta parte del codigo permite el cambio de posicion
}

displayProductos(productos);

const botonDeFiltro = document.querySelector(".button"); //se agrega la clase al html, se agrego un . por ser clase
